...
class N8nSettingsSeeder extends Seeder
{
    public function run(): void
    {
        $settings = [
            ...
            N8nWebhookService::KEY_TEXT_SALARY_REQUEST => 'Permintaan kemaskini gaji guru telah dihantar pada {tarikh}. Sila kemaskini gaji, elaun, elaun transit dan elaun lain semasa.',
