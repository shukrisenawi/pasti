...
class N8nSettingController extends Controller
{
    ...
    public function update(Request $request): RedirectResponse
    {
        ...
        $validated = $request->validate([
            ...
            'text_pasti_info_response_reminder' => ['required', 'string', 'max:2000'],
            'text_guru_course_offer' => ['required', 'string', 'max:2000'],
            'text_guru_course_response_reminder' => ['required', 'string', 'max:2000'],
            'text_program_response_reminder' => ['required', 'string', 'max:2000'],
            ...
            'text_all_guru_completed_thanks' => ['required', 'string', 'max:2000'],
        ...
        $mapping = [
            ...
            'text_pasti_info_response_reminder' => N8nWebhookService::KEY_TEXT_PASTI_INFO_RESPONSE_REMINDER,
            'text_guru_course_offer' => 'n8n_text_guru_course_offer',
            'text_guru_course_response_reminder' => N8nWebhookService::KEY_TEXT_GURU_COURSE_RESPONSE_REMINDER,
            'text_program_response_reminder' => N8nWebhookService::KEY_TEXT_PROGRAM_RESPONSE_REMINDER,
            ...
            'text_all_guru_completed_thanks' => N8nWebhookService::KEY_TEXT_ALL_GURU_COMPLETED_THANKS,
