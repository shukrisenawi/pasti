...
class N8nWebhookService
{
    ...
    public const KEY_TEXT_PROGRAM_RESPONSE_REMINDER = 'n8n_text_program_response_reminder';
    ...
    public const KEY_TEXT_ALL_GURU_COMPLETED_THANKS = 'n8n_text_all_guru_completed_thanks';
    ...
    public function allSettings(): array
    {
        return [
            ...
            'text_program_response_reminder' => $this->template(self::KEY_TEXT_PROGRAM_RESPONSE_REMINDER),
            ...
            'text_all_guru_completed_thanks' => $this->template(self::KEY_TEXT_ALL_GURU_COMPLETED_THANKS),
    ...
    private function template(string $key): string
    {
        return match ($key) {
            ...
            self::KEY_TEXT_PROGRAM_RESPONSE_REMINDER => $this->setting($key, self::DEFAULT_TEXT_PROGRAM_RESPONSE_REMINDER),
            ...
            self::KEY_TEXT_ALL_GURU_COMPLETED_THANKS => $this->setting($key, self::DEFAULT_TEXT_ALL_GURU_COMPLETED_THANKS),
