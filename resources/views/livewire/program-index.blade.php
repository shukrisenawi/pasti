                ...
                >
                    ...
                    <div class="mt-4 flex items-center gap-2">
                        <a
                            ...
                            wire:navigate
                            class="inline-flex items-center justify-center rounded-full bg-emerald-600 px-4 py-2 text-sm font-semibold text-white shadow-sm transition hover:bg-emerald-700 focus:outline-none focus:ring-2 focus:ring-emerald-300"
                        >
                            {{ __('messages.view') }}
                        </a>
                        @if($canManageProgram)
