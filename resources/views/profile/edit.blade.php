<x-app-layout>
    ...
    <x-slot name="header">
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4" x-data="{ tab: '{{ $defaultTab }}' }" @profile-tab-change.window="tab = $event.detail">
            <div>
    ...
    <div class="py-4" x-data="{ tab: '{{ $defaultTab }}' }" @profile-tab-change.window="tab = $event.detail">
