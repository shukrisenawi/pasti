            ...
            @forelse($programs as $program)
                <tr>
                    ...
                    <td class="flex items-center gap-1">
                        <a href="{{ route('programs.show', $program) }}" class="btn btn-ghost btn-xs btn-circle text-primary" title="{{ __('messages.view') }}">
                        ...
                        @role('master_admin|admin')
                        <a href="{{ route('programs.edit', $program) }}" class="btn btn-ghost btn-xs btn-circle text-amber-600" title="{{ __('messages.edit') }}">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="h-5 w-5">
